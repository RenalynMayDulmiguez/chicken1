            ...
            <div class="notification-slider">
              <div>
                <div class="timer-notification">
                  <h6>
                    <strong class="me-1">Welcome to Fried Chickn!</strong>
                    Wrap new offers/gift every signle day on Weekends.
                    <strong class="ms-1">New</strong>
                  </h6>
                </div>
              </div>
              ...
              <div>
                <div class="timer-notification">
                  <h6>
                    ...
                    <a href="#product-area" class="text-white">Buy Now
                      !</a>
                  </h6>
                </div>
              </div>
                ...
                <li class="right-side onhover-dropdown">
                  <div class="delivery-login-box">
                    ...
                    <div class="delivery-detail">
                      <h6>Hello,</h6>
                      <h5><?php echo $_SESSION['user']['fullname'] ?></h5>
                    </div>
                  </div>
